...
double Nanobot::GetDelay()
{
  return 0;
}

int Nanobot::GetTargetOrgan()
{
  return 0;
}

bool Nanobot::HasFingerprintLoaded()
{
  return 0;
}

bool Nanobot::HasTissueDetected()
{
  return 0;
}
...
double
Nanobot::GetDetectionRadius ()
{
  return 0;
}

void
Nanobot::SetDetectionRadius (double value)
{
}
