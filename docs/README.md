...
| follow the active scientific qualification cycle | [PCQ-1 protocol](qualification/PULMONARY_CAPILLARY_QUALIFICATION_PROTOCOL.md), [source screen](qualification/PCQ1_EVIDENCE_SOURCE_SCREEN.md), [pre-outcome amendment](qualification/PCQ1_PRE_OUTCOME_AMENDMENT.md), [rights-aware ingress](qualification/PCQ1_DATA_INGRESS.md), [uncertainty/identifiability report](qualification/PCQ1_UNCERTAINTY_IDENTIFIABILITY.md), [repository-first data audit](qualification/PCQ1_REPOSITORY_FIRST_DATA_AUDIT.md), and [request/waiting-period package](qualification/PCQ1_DATA_REQUEST_PACKAGE.md) | bounded claim, frozen models/sources/observation rules, numeric gates, safe data ingress, uncertainty and identifiability, audited repository availability, governed contact drafts, and the next locked-execution increment |
