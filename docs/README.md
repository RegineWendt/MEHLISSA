...
- [System requirements](requirements/SYSTEM_REQUIREMENTS.md) – 80 numbered functional, architectural, user-experience, and quality requirements with origin, priority, and verification method.
