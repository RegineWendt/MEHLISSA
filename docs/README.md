...
| follow the scientific qualification cycles | [Qualification index](qualification/README.md), [completed BCQ-1 biological cell-model package](qualification/BCQ1_MEHLISSA_QUALIFICATION_RESULT.md), and [DCCQ-1 dynamic coupling plan](qualification/DCCQ1_QUALIFICATION_PLAN.md) | pulmonary/capillary access-dependent work, the bounded average-cell result, and the prospective path from a non-consuming snapshot to dynamic capillary-tissue-cell coupling |
