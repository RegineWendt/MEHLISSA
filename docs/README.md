...
- [System requirements](requirements/SYSTEM_REQUIREMENTS.md) – 76 numbered functional, architectural, user-experience, and quality requirements with origin, priority, and verification method.
