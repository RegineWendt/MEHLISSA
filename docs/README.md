...
| follow the active scientific qualification cycles | [PCQ-1 pulmonary and capillary package](qualification/README.md) and [BCQ-1.1 biological cell-model selection](qualification/BCQ1_BIOLOGICAL_CELL_MODEL_SELECTION.md) | pulmonary/capillary access-dependent work plus the selected public CD95L-CD95-caspase-8 model family and its pre-import licence boundary |
