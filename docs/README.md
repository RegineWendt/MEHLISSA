...
- [M6 – Nano-IoT Communication](m6/README.md) – in-progress communication milestone; M6.1–M6.2 provide versioned devices, traceable detection messages, a replaceable one-hop link, and separate communication metrics.
