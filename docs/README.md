...
| follow the scientific qualification cycles | [Qualification index](qualification/README.md), [completed BCQ-1 biological cell-model package](qualification/BCQ1_MEHLISSA_QUALIFICATION_RESULT.md), [DCCQ-1 dynamic coupling plan](qualification/DCCQ1_QUALIFICATION_PLAN.md), and [DCCQ-1.2 evidence source screen](qualification/DCCQ1_EVIDENCE_SOURCE_SCREEN.md) | pulmonary/capillary access-dependent work, the bounded average-cell result, and the selected VEGF-A165a/VEGFR2 HUVEC path from a non-consuming snapshot to prospectively defined dynamic coupling |
