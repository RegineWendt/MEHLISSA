...
- [M6 – Nano-IoT Communication](m6/README.md) – in-progress communication milestone; M6.1 provides versioned nanodevices, resource/lifecycle accounting, and traceable local messages.
