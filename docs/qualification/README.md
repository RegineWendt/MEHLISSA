...
| [DCCQ-1 dynamic capillary-tissue-cell qualification](DCCQ1_QUALIFICATION_PLAN.md) | DCCQ-1.1 prospective intended-use and compatibility audit complete; DCCQ-1.2 source screen is next | replace the non-consuming homogeneous snapshot with a time-resolved, amount-conserving, evidence-compatible transport, tissue, binding, consumption, and feedback path |
