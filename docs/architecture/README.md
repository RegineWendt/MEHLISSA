...
| [ADR-0050](adr/0050-local-browser-research-workbench.md) | Accepted | local browser workbench hosted by a loopback-only Python client of the accepted process API |
