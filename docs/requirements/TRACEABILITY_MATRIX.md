...
| ARC-003 | DISS pp. 95–97 | PART | PART | M3–M7 | versioned entity, population, substance-amount, volume-flow, body-state, detection, response, and communication-event contracts cross implemented boundaries; DCCQ-1 now adds a typed SI VEGF-A165a/VEGFR2 HUVEC-informed transforming boundary with seven exclusive amount owners, consumptive binding, explicit sinks, and delayed feedback; generic declarative scenario composition and further qualified biochemical identities remain open |
| ARC-004 | RM 3.3 | PART | PART | M3/M4 | entity round trips and lossless population, substance, and flow transit pass across both lung variants and the synthetic organ-capillary route; DCCQ-1 implements and qualifies the seven-owner open-system VEGF-A165a ledger in exact SI, with maximum 41-run balance residual `7.857794173099922e-32 mol`; body aggregate endpoints and external physiological qualification remain open |
...
| ARC-006 | RM 3.3 | PART | PART | M3 | externally selected coarse/regional results agree at 0.5 s and 1 s, the 6.4 s pulmonary 0D route agrees at 0.1 s and 0.2 s, and M3.18 executes one 0.1 s scenario across coarse and five-lobe candidates; DCCQ-G4 independently refines RK4 step and coupling interval, while DCCQ-G5 passes bounded next-interval feedback timing with 240 s scheduling and 300 s application; general asynchronous multirate orchestration remains open |
...
| CAP-004 | DISS p. 127 | DONE | PART | M4 | M4.5 partitions typed amount at one transit boundary; DCCQ-1 adds a separate time-resolved, bidirectional and consumptive VEGF-A165a path across blood-free, endothelial-free, interstitial-free, receptor-bound, internalized, cleared/degraded, and outlet owners. Balance, limiting cases, convergence and timing are computationally qualified; transfer, clearance and feedback values remain engineering assumptions rather than physiological capillary evidence. |
...
| CELL-001 | DISS pp. 129–132 | PART | PART | M5 | analytical and finite-volume biomarker-field references exist; DCCQ-1 implements a reduced well-mixed SI VEGF-A165a/VEGFR2 HUVEC-informed equation set with NRP1 explicit, receptor-capacity saturation, consumptive binding, internalization, degradation and 24 local-sensitivity comparisons. A spatial cell field, joint parameter distribution, observational covariance and independent biological validation remain open. |
...
| CELL-003 | DISS pp. 130–132, 153–154 | PART | PART | M5 | M5.6 provides a conservative drug-release/uptake chain and M5.7 a synthetic response; DCCQ-1 adds named VEGF-A165a/VEGFR2 consumptive binding, separate bound/internalized/cleared owners and one-interval delayed bounded occupancy feedback. The causal software gate passes, while spatial diffusion-to-cell composition, calibrated feedback, downstream VEGFR2 signalling and independent biological validation remain open. |
