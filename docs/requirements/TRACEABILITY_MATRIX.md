...
| ORG-002 | DISS pp. 118–122 | PART | M3 | M2.4 checks whole-body perfusion; M3.7 adds source-scoped aggregate physiology; M3.8–M3.13 add independent evaluation and empirical flow/age refinements; M3.14–M3.15 test pressure distensibility without hiding inferior validation; M3.16 adds five anatomically named parallel lobe beds with a declared DE-CT proxy, exact aggregate equivalence, and deterministic entity routing; independent lobar validation remains open |
