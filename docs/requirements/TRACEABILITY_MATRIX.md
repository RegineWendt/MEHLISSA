...
| DATA-008 | RM 6.2 | DONE | PART | M5/M7 | stochastic moments, Wilson intervals, particle comparisons, campaign summaries, and Paper 1 conditions/seeds/tolerances use declared statistics; PCQ-1.1–1.3 freeze endpoints, uncertainty floors, six numeric gates, minimum samples, equivalence/bootstrap rules, and inconclusive/blocked states; PCQ-1.4 carries method uncertainty and sample floors into four strict normalized adapters; execution, identifiability, and release-wide uncertainty propagation remain open |
