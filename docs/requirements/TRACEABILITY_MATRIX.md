...
| DATA-006 | RM 6.2 | DONE | PART | M0 | the Paper 1 matrix and source-role audit make calibration/validation/verification roles and overlap explicit across six families; M3.8–M3.17 retain source-disjoint and negative pulmonary findings; PCQ-1 adds a machine-checked pre-outcome no-refit design and strict amendment rule; participant-level data and completed independent pulmonary-capillary qualification still follow |
