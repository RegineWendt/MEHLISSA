...
| ARC-003 | DISS pp. 95–97 | PART | PART | M3–M7 | versioned entity, population, substance-amount, volume-flow, body-state, detection, response, and communication-event contracts cross implemented boundaries; broader transforming exchanges and generic scenario composition remain open |
| ARC-004 | RM 3.3 | PART | PART | M3/M4 | entity round trips and lossless population, substance, and flow transit pass across both lung variants and the synthetic organ-capillary route; transforming exchange and body aggregate endpoints follow |
...
| ARC-006 | RM 3.3 | PART | PART | M3 | externally selected coarse/regional results agree at 0.5 s and 1 s, the 6.4 s pulmonary 0D route agrees at 0.1 s and 0.2 s, and M3.18 executes one 0.1 s scenario across coarse and five-lobe candidates; asynchronous multirate synchronization follows |
...
| ORG-002 | DISS pp. 118–122 | DONE | PART | M3 | M2.4 checks whole-body perfusion; M3.7 adds source-scoped aggregate physiology; M3.8–M3.13 add independent evaluation and empirical flow/age refinements; M3.14–M3.15 test pressure distensibility without hiding inferior validation; M3.16 adds five anatomically named parallel lobe beds with a declared DE-CT proxy and exact aggregate equivalence; M3.17 independently qualifies all five fixed normal-supine shares against both published V/Q SPECT/CT reconstructions; PCQ-1 v0.1 freezes participant-level hemodynamic and regional-perfusion endpoints, and PCQ-1.2 ranks the Arizona iCPET and Bailey five-lobe access paths while rejecting PVDOMICS as the initial healthy invasive source under its published protocol; measured participant trajectories and dynamic regional states remain open |
...
| CAP-002 | DISS pp. 126–129 | DONE | PART | M4 | M4.7 pulmonary card separates functional perfused volume from morphometric capacity, records parameter-level evidence and uncertainty, and enforces equivalent-geometry volume-flow-transit closure; PCQ-1 v0.1 freezes the candidate hash and predeclares capillary volume, transit, hematocrit, and joint-coherence endpoints; PCQ-1.2 prioritizes D'Souza 2025 joint functional-volume/flow records and a separate Lassen 2023 whole-pulmonary transit observation model while retaining the algebraic-independence limitation; independent participant-level evaluation still follows |
...
| CAP-004 | DISS p. 127 | DONE | PART | M4 | optional M4.5 profile partitions typed substance amount across outgoing blood, endothelium, interstitium, and cell with an enforced balance record and complete organ-capillary-organ test; physiological kinetics, reverse flux, metabolism, and qualification follow |
...
| CELL-004 | DISS pp. 131–133, 154 | DONE | PART | M5 | M5.5 provides one conserved topology as bounded ODE and exact SSA with analytical constant-input equilibria, fixed transient values, and a 1,000-cell population comparison; external biological reaction data remain open |
...
| DATA-006 | RM 6.2 | DONE | PART | M0 | the Paper 1 matrix and source-role audit make calibration/validation/verification roles and overlap explicit across six families; M3.8–M3.17 retain source-disjoint and negative pulmonary findings; PCQ-1 adds a machine-checked pre-outcome no-refit design and strict amendment rule; PCQ-1.2 adds a thirteen-source register with track-specific rankings, independence and cohort-reuse review, rights, rejection reasons, and public-outcome exposure; participant-level data and completed independent pulmonary-capillary qualification still follow |
...
| DATA-008 | RM 6.2 | DONE | PART | M5/M7 | stochastic receptor population moments, Wilson classification intervals, particle-channel comparisons, campaign replicate summaries, and Paper 1 predeclared conditions/seeds/repetitions/tolerances use declared statistical semantics; PCQ-1 predeclares six primary endpoints, sample-size/tolerance locking, observational, parameter, structural and numerical uncertainty, sensitivity, and identifiability; PCQ-1.2 records candidate repeatability, covariance, missingness, and outcome-exposure gaps without inventing thresholds; the numeric amendment, execution, and release-wide uncertainty propagation remain open |
...
| QUA-006 | RM M8 | SPEC | UNVERIFIED | M8 | data-protection and data-management review |
