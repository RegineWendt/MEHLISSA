...
| DATA-006 | RM 6.2 | DONE | PART | M0 | the Paper 1 matrix and source-role audit make calibration/validation/verification roles and overlap explicit across six families; M3.8–M3.17 retain source-disjoint and negative pulmonary findings; PCQ-1.1/1.2 add a machine-checked no-refit design and thirteen-source register with track rankings, independence, cohort reuse, rights, rejection reasons, and public-outcome exposure; PCQ-1.3 binds four guarded source roles and amendment-after-access rules; participant data and completed independent pulmonary-capillary qualification still follow |
...
| DATA-008 | RM 6.2 | DONE | PART | M5/M7 | stochastic receptor population moments, Wilson classification intervals, particle-channel comparisons, campaign replicate summaries, and Paper 1 predeclared conditions/seeds/repetitions/tolerances use declared statistical semantics; PCQ-1.1/1.2 predeclare six primary endpoints and record repeatability, covariance, missingness, and outcome exposure; PCQ-1.3 freezes method-informed uncertainty floors, six numeric gates, minimum samples, 90% equivalence/bootstrap rules, and inconclusive/blocked states; execution, identifiability, and release-wide uncertainty propagation remain open |
