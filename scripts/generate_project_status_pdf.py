...
def cover_story() -> list:
    status = Table(
        [
            ...
            [Paragraph("Architecture and implementation", STYLES["CoverMeta"]), Paragraph("All milestone gates", STYLES["CoverMeta"]), Paragraph("UX-2 CI verification, then UX-3 reporting", STYLES["CoverMeta"])],
        ],
    ...
    return [
        ...
        Paragraph("Branch: mehlissa-next-generation | Base revision: a96b4ce", STYLES["CoverMeta"]),
