...
def cover_story() -> list:
    status = Table(
        [
            ...
            [Paragraph("Architecture and implementation", STYLES["CoverMeta"]), Paragraph("All milestone gates", STYLES["CoverMeta"]), Paragraph("UX-3 through UX-5 cross-platform acceptance", STYLES["CoverMeta"])],
        ],
    ...
    return [
        ...
        Paragraph("Branch: mehlissa-next-generation | Base revision: f49a7af", STYLES["CoverMeta"]),
