...
def cover_story() -> list:
    status = Table(
        [
            ...
            [Paragraph("Architecture and implementation", STYLES["CoverMeta"]), Paragraph("All milestone gates", STYLES["CoverMeta"]), Paragraph("UX-6.8 release acceptance", STYLES["CoverMeta"])],
        ],
    ...
    return [
        ...
        Paragraph("Branch: mehlissa-next-generation | Published base: 7b92c4e | UX-6.1 through UX-6.7 local", STYLES["CoverMeta"]),
